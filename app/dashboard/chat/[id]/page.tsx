...
export default function ChatTicketPage() {
  ...
  const log = useLogger('ChatTicketAluno', '/dashboard/chat/[id]')
  ...
  useEffect(() => {
    ...
    log.info('Página de chat ticket carregada', {
  ...
  // useEffect(() => {
  //   if (ticket && user && ticket.messages && ticket.messages.length > 0) {
  //     // Verificar se há mensagens não lidas do outro usuário
  //     const hasUnreadMessages = ticket.messages.some((msg: ChatMessage) => 
  ...
  const handleSendMessage = async () => {
    console.log('handleSendMessage chamado:', { message, attachments: attachments.length, ticketId })
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {ticket.essayId ? getEssayTitle(ticket.essayId) : 'Chat Geral'}
                  </p>
                </div>
              </div>
